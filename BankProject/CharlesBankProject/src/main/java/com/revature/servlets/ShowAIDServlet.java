...
public class ShowAIDServlet extends HttpServlet {
...
protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			ResultSet resultSet = stmt.executeQuery("SELECT t.accountid, u.firstname, u.lastname FROM accounts t, bankuser u WHERE t.email = u.email ORDER BY t.accountid");
