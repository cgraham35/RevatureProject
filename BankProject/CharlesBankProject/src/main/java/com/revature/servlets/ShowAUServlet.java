...
public class ShowAUServlet extends HttpServlet {
...
protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			ResultSet resultSet = stmt.executeQuery("SELECT t.accountid, t.balance, u.firstname, u.lastname FROM accounts t, bankuser u WHERE t.email = u.email ORDER BY u.lastname");
			...
			//TABLE DATA ROW
					while(resultSet.next()) {
						...
						out.println("<td>");
						out.println(resultSet.getFloat("balance"));
						out.println("</td>");
